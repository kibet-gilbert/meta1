...
step6: convert the bash script to a nextflow workflow (scripts/meta1_pipeline_draft.nf)
...
step8: create a singularity/apptainer definition file (scripts/meta1_apptainer.def)
...
step10: Deploy the image with different test data:
	- This two datasets are provided with the pipeline
	$ ~/Downloads/Programs/nextflow run ./scripts/meta1_pipeline.nf -with-apptainer ./scripts/meta1_apptainer.sif -resume
	$ ~/Downloads/Programs/nextflow run ./scripts/meta1_pipeline.nf -with-apptainer ./scripts/meta1_apptainer.sif -resume --reads='data/fastq/raw-data/*_L001_R{1,2}_001.fastq.gz'
	- Here is how to use your own data - illumina shotgun metagenomics
	$ ~/Downloads/Programs/nextflow run ./scripts/meta1_pipeline.nf -with-apptainer ./scripts/meta1_apptainer.sif -resume --reads='data/fastq/raw-data2/*_R{1,2}.fastq.gz'
	$ ~/Downloads/Programs/nextflow run ./scripts/meta1_pipeline.nf -with-apptainer ./scripts/meta1_apptainer.sif -resume --reads='data/fastq/hev_data/*_S*_con_R{1,2}_001.fastq.gz'
